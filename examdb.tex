...
\addpoints%
\begin{questions}%
\addpoints\question[3]asdfasdfsa0
asdfasdfsa $0$, \begin{equation}sdfsfnd{dsfad}
\end{equation}asfasfa0asafdsa.\[dsfad\]\begin{parts}\noaddpoints\part[1]asdfasdfsa0
asdfasdfsa0
asfasfa0asafdsa.\begin{solution}0 asdfsf
asdfasdfsa0
asdfasdfsa0
asfasfa0asafdsa.\end{solution}\noaddpoints\part[2]asdfasdfsa0
asdfasdfsa0
asfasfa0asafdsa.\begin{solution}0 asdfsf
asdfasdfsa0
asdfasdfsa0
asfasfa0asafdsa.\end{solution}\end{parts}%
\addpoints\question[3]asdfasdfsa0
asdfasdfsa $0$, \begin{equation}sdfsfnd{dsfad}
\end{equation}asfasfa0asafdsa.\[dsfad\]\begin{parts}\noaddpoints\part[1]asdfasdfsa0
asdfasdfsa0
...
\addpoints\question[3]asdfasdfsa0
asdfasdfsa $0$, \begin{equation}sdfsfnd{dsfad}
\end{equation}asfasfa0asafdsa.\[dsfad\]asdfasdfsa0
asdfasdfsa0
asfasfa0asafdsa.\begin{solution}0 asdfsf
asdfasdfsa0
asdfasdfsa0
